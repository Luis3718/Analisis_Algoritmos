...
//lo que se ocupa para la coidficacion de Huffman
	...
	while(frase[i]!='\0') //Recorremos la frase hasta el final para encontrar las frecuencias de caracteres
	{
		...
		else
		{
			...
			if(flag==0)
			{
				...
				Listagenerada=Altafinal(Listagenerada,frase[i],1,NULL); //añadimos un nuevo caracter a la lista
			}
...
int main()
{
	...
	do
	{
		...
		switch(opcion)
		{
			...
			break;
			case 2: printf("Codificado de Huffman: ");
							printf("%s\n",codc);
			break;
			case 3: printf("Adios \n");
			break;
