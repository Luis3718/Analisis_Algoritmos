/*
  Algoritmo del granjero y su Big O 
...
int main()
{
	...
	//int f=1+rand()%100;
	int f=30;
	int c[]={0,29,36,50,52,66,71,85,100,117,127,129,135,146,150,180,191,195,199,205,212,218,225,229,235,250,272,277,285,290,300,315,323,329,333,359,368,369,372,376,382,388,396,401,405,409,417,422,425,435};
	ctd=0;
	int s1[n];
	n=5;
	granjero(c,s1,n,f,&ctd);
	fprintf(pd,"%d,%d\n",n,ctd);
	/*n=5;
	for(int r=0;r<pts;r++)
	{	
